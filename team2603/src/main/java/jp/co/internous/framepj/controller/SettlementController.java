...
public class SettlementController {
	...
	public String index(Model m) {
		...
		m.addAttribute("destinations", destinationMapper.findByUserId(userId));
	...
	public boolean complete(@RequestBody String destinationId) {
		...
		int destId = Integer.parseInt(map.get("destinationId"));

		int userId = loginSession.getUserId();

		purchaseHistoryMapper.insert(destId, userId);
